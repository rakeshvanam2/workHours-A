...
(() => {
  ...
  var Je = (e, t, o) =>
    t in e
      ? G(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o })
      : (e[t] = o);
  var Ze = (e, t) => () => (
  ...
  var tt = (e, t, o) => (
    ...
    et(
      t || !e || !e.__esModule
        ? G(o, "default", { value: e, enumerable: !0 })
        : o,
      e
    )
  );
  ...
  var me = { addToCartForm: "w-commerce-commerceaddtocartform" },
    ue = { trigger: "w-lightbox" };
  ...
  var S = `fs-${h}`,
    ...
    B = {
      ...
      mode: { key: `${S}-${ht}`, values: It },
      threshold: { key: `${S}-${Rt}` },
      pageSiblings: { key: `${S}-${vt}` },
      pageBoundary: { key: `${S}-${Mt}` },
      animation: { key: `${S}-${Bt}` },
      easing: { key: `${S}-${Nt}` },
      duration: { key: `${S}-${Ut}` },
      stagger: { key: `${S}-${Ot}` },
      resetIx: { key: `${S}-${Dt}`, values: $t },
      showQuery: { key: `${S}-${kt}`, values: Kt },
      cacheItems: { key: `${S}-${Vt}`, values: Ht },
    },
    [F, b] = k(B),
    Re = "-20",
    ve = 1,
    Me = 1,
    Be = { main: 0, medium: 1, small: 2, tiny: 3 };
  var {
      pageSiblings: { key: Ft },
      pageBoundary: { key: Gt },
      threshold: { key: Wt },
    ...
    Ne = (e) => {
      ...
      if (!t) return;
      let r = b("pageButton", { operator: "prefixed", scope: t }),
        n = b("pageDots", { operator: "prefixed", scope: t });
      n
        ? n.remove()
  ...
  var Ke = async (e) => {
    ...
    Jt = (e, t, o) => {
      let { target: r } = e;
      if (!ie(r)) return;
      let n = r.closest(F("element", "pageButton", { operator: "prefixed" })),
  ...
  var {
    ...
    We = async (e, t) => {
      ...
      t.addItemsAnimation(e, {
        ...
        t.addListAnimation(e, { durationKey: Fe, easingKey: Ge });
      let i =
        s &&
        !!n.require("commerce") &&
      ...
      if (!e.visibleCount || !e.visibleCountFrom || !e.visibleCountTo) {
        let l = b("visibleCount", { instanceIndex: o }),
          E = b("visibleCountFrom", { instanceIndex: o }),
          x = b("visibleCountTo", { instanceIndex: o });
  ...
  var Ye = async () => {
    ...
    let t = e.createCMSListInstances([
        F("element", "list", { operator: "prefixed" }),
      ]),
